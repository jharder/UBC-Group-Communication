...
import net.sf.appia.gossip.GossipServer;
...
public class Rainbow {
  ...
  public static final int DEFAULT_GOSSIP_PORT=20005;
...
//    }
    ...
    final RainSession as=(RainSession)qos[qos.length-1].createSession();
    if (ssl)
