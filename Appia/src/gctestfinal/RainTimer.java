...
public class RainTimer extends Timer {

  public RainMessage msg;
  public int totalResend, thisResend, period;
  public int[] dest;

  private RainSession parent;

  public RainTimer(Channel c,RainSession gen, RainMessage msg, int totalResend,int period, int[] dest) throws AppiaEventException, AppiaException {
