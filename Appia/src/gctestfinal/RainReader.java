...
class RainReader implements Runnable {

  private RainSession         parentSession;
  private java.io.BufferedReader keyb;
  private String                 local=null;

  public RainReader(RainSession parentSession) {
    super();
  ...
  public void run() {
    while(true) {
      try {
        local=keyb.readLine();
		RainAsyncStringEvent asyn = new RainAsyncStringEvent(local);
