 ...
 */
public class RainAsyncStringEvent extends Event {
	 ...
	 */
	public RainAsyncStringEvent(String s) {
		super();
		comLine = s;
	}
	 ...
	 */
	public RainAsyncStringEvent(Channel channel, int direction, Session src)
		throws AppiaEventException {
