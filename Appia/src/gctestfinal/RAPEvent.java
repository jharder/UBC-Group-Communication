 ...
 */
public class RAPEvent extends Event {

	private long comLine;

	/**
	 * Constructor for ApplAsyncEvent.
	 */
	public RAPEvent(long s) {
		super();
		comLine = s;
	}
	 ...
	 */
	public RAPEvent(Channel channel, int direction, Session src)
		throws AppiaEventException {
	 ...
	 */
	public void setComLine(long comLine) {
